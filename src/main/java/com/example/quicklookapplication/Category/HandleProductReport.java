...
public class HandleProductReport implements Initializable {
    @FXML
    private TableView<ProductReport> productReportView;
    @FXML
    private TableColumn<ProductReport, Integer> tableId;
    @FXML
    private TableColumn<ProductReport, String> tableProductName;
    @FXML
    private TableColumn<ProductReport, String> tableProductCategory;
    @FXML
    private TableColumn<ProductReport, String> tableProductBrand;
    @FXML
    private TableColumn<ProductReport, String> tableProductPurchasePrice;
    @FXML
    private TableColumn<ProductReport, String> tableProductSalePrice;
    @FXML
    private TableColumn<ProductReport, String> tableProductStatus;

    @FXML
    private Button goBackToHomePage;

    public HandleProductReport() {
    }
    ...
    public ObservableList<ProductReport> getProductList() {
        ObservableList<ProductReport> productList = FXCollections.observableArrayList();
    ...
    public void showProducts() {
        ObservableList<ProductReport> list = this.getProductList();
        ...
        this.productReportView.setItems((ObservableList) null);
        this.productReportView.setItems(list);
    }
